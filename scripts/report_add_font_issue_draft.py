...
OUTPUT_DEFAULT = Path("documentation/google-fonts-add-font-issue-draft.md")
...
def markdown_report(gf_repo: Path) -> str:
    ...
    reports = {
        ...
        "family_name": read_text("documentation/family-name-readiness.md"),
        "upstream": read_text("documentation/upstream-structure-readiness.md"),
        "latin": read_text("documentation/missing-gf-latin-core.md"),
        "arabic": read_text("documentation/missing-gf-arabic-core.md"),
        "arabic_marks": read_text("documentation/arabic-mark-readiness.md"),
        "arabic_review": read_text("documentation/arabic-review-packet.md"),
        "arabic_shaping": read_text("documentation/arabic-shaping-smoke-test.md"),
        "numeric": read_text("documentation/numeric-feature-readiness.md"),
        "authorship": read_text("documentation/authorship-disclosure-readiness.md"),
        "designer_profile": read_text("documentation/designer-profile-readiness.md"),
        "designer_profile_package": read_text("documentation/designer-profile-package-draft.md"),
        "pua": read_text("documentation/pua-scope.md"),
        "vendor": read_text("documentation/vendor-id-readiness.md"),
        "kerning": read_text("documentation/kerning-readiness.md"),
        "kerning_proof_review": read_text("documentation/kerning-proof-review.md"),
        "avar": read_text("documentation/avar-readiness.md"),
        "warnings": read_text("documentation/fontspector-warnings.md"),
        "package_dry_run": read_text("documentation/package-dry-run-readiness.md"),
        "downstream_metadata_diff": read_text("documentation/downstream-metadata-diff.md"),
        "packager_source_strategy": read_text("documentation/packager-source-strategy.md"),
    }
    ...
    source_strategy_matrix = first_line_value(
        ...
        "review `documentation/packager-source-strategy.md`",
    )
