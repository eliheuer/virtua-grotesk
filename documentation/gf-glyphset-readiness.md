...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `GF_Latin_Kernel` | Latin | 116 | 116 | 0 | 100.00% | none |
| `GF_Latin_Core` | Latin | 319 | 319 | 0 | 100.00% | `ca_Latn`, `cs_Latn`, `cy_Latn`, `da_Latn`, `de_Latn`, `en_Latn`, `es_Latn`, `fi_Latn`, `fr_Latn`, `hr_Latn`, `hu_Latn`, `is_Latn`, `it_Latn`, `lt_Latn`, `lv_Latn`, `mt_Latn`, `nb_Latn`, `nl_Latn`, `pl_Latn`, `pt_Latn`, `ro_Latn`, `sk_Latn`, `sq_Latn`, `sr_Latn`, `sv_Latn`, `tr_Latn` |
| `GF_Arabic_Core` | Arabic | 224 | 224 | 0 | 100.00% | `ar_Arab`, `fa_Arab`, `ur_Arab` |
| `GF_Arabic_Plus` | Arabic | 267 | 229 | 38 | 74.83% | `ckb_Arab`, `zlm_Arab`, `ps_Arab`, `sd_Arab`, `ug_Arab`, `ar_Arab`, `fa_Arab`, `ur_Arab` |
