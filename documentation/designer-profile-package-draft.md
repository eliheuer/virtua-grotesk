...
- Default info candidate: `documentation/designer-profile-candidate/info.pb`
- Default bio candidate: `documentation/designer-profile-candidate/bio.html`
- Default image candidate: `documentation/designer-profile-candidate/eliheuer.png`
- Candidate info/bio link consistency: yes
...
- Current dry-run blocker details:
  - image file does not exist: /Users/eli/GH/repos/virtua-grotesk/documentation/designer-profile-candidate/eliheuer.png
...
| Biography | candidate draft in `documentation/designer-profile-candidate/bio.html`; maintainer approval pending | Approve or replace a third-person `bio.html` snippet that passes `make designer-profile-bio-check`; if `info.pb` uses a non-empty link, include that same URL in the bio links. |
...
A validator-ready but unapproved biography draft lives at `documentation/designer-profile-candidate/bio.html`.
...
```bash
make designer-profile-bio-check BIO=documentation/designer-profile-candidate/bio.html
```
...
A validator-ready but unapproved `info.pb` draft lives at `documentation/designer-profile-candidate/info.pb`.
...
```bash
make designer-profile-info-check INFO=documentation/designer-profile-candidate/info.pb
```
