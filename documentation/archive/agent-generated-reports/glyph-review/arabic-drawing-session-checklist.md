...
- `proof-regular-glyphs` (GF proof: Regular glyphs)
  ...
  - Open: `documentation/google-fonts/gftools-qa/Proof/Regular-diffbrowsers_glyphs.html`; `documentation/glyph-review/arabic-manual-review-dashboard.html`; `documentation/glyph-review/review-snapshots/proof-regular-glyphs.png`
...
- `proof-medium-glyphs` (GF proof: Medium glyphs)
  - Cue: Glyphs proof: missing, clipped, blank, malformed, duplicated, or wrong-codepoint Arabic glyphs
  - Open: `documentation/google-fonts/gftools-qa/Proof/Medium-diffbrowsers_glyphs.html`; `documentation/glyph-review/arabic-manual-review-dashboard.html`; `documentation/glyph-review/review-snapshots/proof-medium-glyphs.png`
...
- `proof-semibold-glyphs` (GF proof: SemiBold glyphs)
  - Cue: Glyphs proof: missing, clipped, blank, malformed, duplicated, or wrong-codepoint Arabic glyphs
  - Open: `documentation/google-fonts/gftools-qa/Proof/SemiBold-diffbrowsers_glyphs.html`; `documentation/glyph-review/arabic-manual-review-dashboard.html`; `documentation/glyph-review/review-snapshots/proof-semibold-glyphs.png`
...
- `proof-bold-glyphs` (GF proof: Bold glyphs)
  - Cue: Glyphs proof: missing, clipped, blank, malformed, duplicated, or wrong-codepoint Arabic glyphs
  - Open: `documentation/google-fonts/gftools-qa/Proof/Bold-diffbrowsers_glyphs.html`; `documentation/glyph-review/arabic-manual-review-dashboard.html`; `documentation/glyph-review/review-snapshots/proof-bold-glyphs.png`
