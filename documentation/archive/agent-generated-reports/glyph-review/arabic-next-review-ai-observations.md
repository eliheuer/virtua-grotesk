...
| `smoke-salaam` | Dashboard snapshot evidence is present and the shaping smoke report mechanically passes. Human review still needs to judge rhythm, joins, and style fit in the rendered string. | Open `documentation/glyph-review/arabic-shaping-smoke-test.md` and the dashboard; confirm joins and spacing visually before passing. |
| `smoke-arabic` | Dashboard snapshot evidence is present and the shaping smoke report mechanically passes. Human review still needs to judge rhythm, joins, and style fit in the rendered string. | Open `documentation/glyph-review/arabic-shaping-smoke-test.md` and the dashboard; confirm joins and spacing visually before passing. |
...
| ---: | --- | --- |
| 1 | `proof-regular-glyphs` | `documentation/glyph-review/review-snapshots/proof-regular-glyphs.png` from `documentation/google-fonts/gftools-qa/Proof/Regular-diffbrowsers_glyphs.html`<br>`documentation/glyph-review/review-snapshots/proof-regular-glyphs-arabic-zoom.png` from `documentation/glyph-review/review-snapshots/proof-regular-glyphs.png` |
| 2 | `proof-medium-glyphs` | `documentation/glyph-review/review-snapshots/proof-medium-glyphs.png` from `documentation/google-fonts/gftools-qa/Proof/Medium-diffbrowsers_glyphs.html`<br>`documentation/glyph-review/review-snapshots/proof-medium-glyphs-arabic-zoom.png` from `documentation/glyph-review/review-snapshots/proof-medium-glyphs.png` |
| 3 | `proof-semibold-glyphs` | `documentation/glyph-review/review-snapshots/proof-semibold-glyphs.png` from `documentation/google-fonts/gftools-qa/Proof/SemiBold-diffbrowsers_glyphs.html`<br>`documentation/glyph-review/review-snapshots/proof-semibold-glyphs-arabic-zoom.png` from `documentation/glyph-review/review-snapshots/proof-semibold-glyphs.png` |
| 4 | `proof-bold-glyphs` | `documentation/glyph-review/review-snapshots/proof-bold-glyphs.png` from `documentation/google-fonts/gftools-qa/Proof/Bold-diffbrowsers_glyphs.html`<br>`documentation/glyph-review/review-snapshots/proof-bold-glyphs-arabic-zoom.png` from `documentation/glyph-review/review-snapshots/proof-bold-glyphs.png` |
| 5 | `class-letter-structures` | `documentation/glyph-review/review-snapshots/class-letter-structures.png` from `documentation/glyph-review/arabic-structure-sweep.html`<br>`documentation/glyph-review/review-snapshots/class-letter-structures-2.png` from `documentation/glyph-review/arabic-visual-risk-proof.html` |
| 6 | `mark-base+fatha` | `documentation/glyph-review/review-snapshots/mark-base+fatha.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 7 | `mark-base+damma` | `documentation/glyph-review/review-snapshots/mark-base+damma.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 8 | `mark-base+kasra` | `documentation/glyph-review/review-snapshots/mark-base+kasra.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 9 | `mark-shadda+sukun` | `documentation/glyph-review/review-snapshots/mark-shadda+sukun.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 10 | `mark-tanween` | `documentation/glyph-review/review-snapshots/mark-tanween.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 11 | `mark-hamza-above-below` | `documentation/glyph-review/review-snapshots/mark-hamza-above-below.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 12 | `mark-dotted-circle` | `documentation/glyph-review/review-snapshots/mark-dotted-circle.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 13 | `class-mark-combinations` | `documentation/glyph-review/review-snapshots/class-mark-combinations.png` from `documentation/glyph-review/arabic-mark-review-proof.html` |
| 14 | `class-dot-stack-helpers` | `documentation/glyph-review/review-snapshots/class-dot-stack-helpers.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
| 15 | `proof-regular-text` | `documentation/glyph-review/review-snapshots/proof-regular-text.png` from `documentation/google-fonts/gftools-qa/Proof/Regular-diffbrowsers_text.html` |
| 16 | `proof-regular-proofer` | `documentation/glyph-review/review-snapshots/proof-regular-proofer.png` from `documentation/google-fonts/gftools-qa/Proof/Regular-diffbrowsers_proofer.html` |
| 17 | `proof-regular-waterfall` | `documentation/glyph-review/review-snapshots/proof-regular-waterfall.png` from `documentation/google-fonts/gftools-qa/Proof/Regular-diffbrowsers_waterfall.html` |
| 18 | `proof-medium-text` | `documentation/glyph-review/review-snapshots/proof-medium-text.png` from `documentation/google-fonts/gftools-qa/Proof/Medium-diffbrowsers_text.html` |
| 19 | `proof-medium-proofer` | `documentation/glyph-review/review-snapshots/proof-medium-proofer.png` from `documentation/google-fonts/gftools-qa/Proof/Medium-diffbrowsers_proofer.html` |
| 20 | `proof-medium-waterfall` | `documentation/glyph-review/review-snapshots/proof-medium-waterfall.png` from `documentation/google-fonts/gftools-qa/Proof/Medium-diffbrowsers_waterfall.html` |
| 21 | `proof-semibold-text` | `documentation/glyph-review/review-snapshots/proof-semibold-text.png` from `documentation/google-fonts/gftools-qa/Proof/SemiBold-diffbrowsers_text.html` |
| 22 | `proof-semibold-proofer` | `documentation/glyph-review/review-snapshots/proof-semibold-proofer.png` from `documentation/google-fonts/gftools-qa/Proof/SemiBold-diffbrowsers_proofer.html` |
| 23 | `proof-semibold-waterfall` | `documentation/glyph-review/review-snapshots/proof-semibold-waterfall.png` from `documentation/google-fonts/gftools-qa/Proof/SemiBold-diffbrowsers_waterfall.html` |
| 24 | `proof-bold-text` | `documentation/glyph-review/review-snapshots/proof-bold-text.png` from `documentation/google-fonts/gftools-qa/Proof/Bold-diffbrowsers_text.html` |
| 25 | `proof-bold-proofer` | `documentation/glyph-review/review-snapshots/proof-bold-proofer.png` from `documentation/google-fonts/gftools-qa/Proof/Bold-diffbrowsers_proofer.html` |
| 26 | `proof-bold-waterfall` | `documentation/glyph-review/review-snapshots/proof-bold-waterfall.png` from `documentation/google-fonts/gftools-qa/Proof/Bold-diffbrowsers_waterfall.html` |
| 27 | `smoke-salaam` | `documentation/glyph-review/review-snapshots/smoke-salaam.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
| 28 | `smoke-arabic` | `documentation/glyph-review/review-snapshots/smoke-arabic.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
| 29 | `smoke-bismillah` | `documentation/glyph-review/review-snapshots/smoke-bismillah.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
| 30 | `smoke-lam-alef` | `documentation/glyph-review/review-snapshots/smoke-lam-alef.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
| 31 | `class-arabic-farsi-numerals` | `documentation/glyph-review/review-snapshots/class-arabic-farsi-numerals.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
| 32 | `class-arabic-punctuation` | `documentation/glyph-review/review-snapshots/class-arabic-punctuation.png` from `documentation/glyph-review/arabic-manual-review-dashboard.html` |
