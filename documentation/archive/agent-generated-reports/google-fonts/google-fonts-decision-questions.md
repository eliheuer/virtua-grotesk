...
`documentation/google-fonts/google-fonts-decisions.md` and the affected source metadata.
...
- `documentation/google-fonts/package-source-files-audit.md` currently reports
...
- The served variable TTF exists locally, but is ignored/generated and not
  tracked by git.
- `documentation/google-fonts/ARTICLE.en_us.html` and
  `documentation/assets/readme-specimen.png` are tracked by git.
...
- `documentation/google-fonts/recent-google-fonts-packages.md` compares recent merged
...
- Packager can use upstream files or release assets, depending on the final
  source strategy.
- `documentation/google-fonts/package-source-files-audit.md` currently shows that the served
...
- The same audit currently shows `source.files` as 3/4 tracked and
  ...
  packaging.
- Recent merged upstream repos in `documentation/google-fonts/recent-google-fonts-packages.md`
...
- The current generated report, `documentation/google-fonts/pua-scope.md`, records 23 currently encoded PUA codepoints in the built variable font.
...
- Google Fonts visual spacing/kerning review is tracked through
  `make kerning-proof-check` and `documentation/google-fonts/kerning-readiness.md`.
