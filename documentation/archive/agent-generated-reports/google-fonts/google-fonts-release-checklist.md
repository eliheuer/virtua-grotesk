...
- Confirm `documentation/google-fonts/google-fonts-decisions.md` has no unresolved blocker
...
- Confirm `documentation/proofs/proof.pdf`, `documentation/glyph-review/arabic-shaping-smoke-test.md`, and
  `documentation/glyph-review/arabic-mark-readiness.md` have been reviewed after the final
  drawing/build pass.
- Confirm `documentation/google-fonts/ARTICLE.en_us.html` has the final upstream link, or
  confirm Google Fonts wants the legacy `DESCRIPTION.en_us.html` instead.
- Confirm `documentation/google-fonts/google-fonts-downstream-package-preview.md` matches the
...
- Confirm generated reports match the released build, especially
  ...
  `documentation/google-fonts/fontspector-contour-count.md`, and
...
`documentation/google-fonts/google-fonts-decisions.md` and verify the current source/build
version evidence in `documentation/google-fonts/release-metadata.md`.
Use `documentation/google-fonts/release-source-readiness.md` for the current commit, dirty
