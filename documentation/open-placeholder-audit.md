...
- Placeholder upstream URL occurrences: 1
...
These rows are generated reports echoing internal guard evidence or the public URL replacement audit. They do not create a public handoff blocker while the public placeholder blocker count is 0.

| Kind | File | Line | Text |
| --- | --- | ---: | --- |
| placeholder upstream URL | `documentation/public-upstream-readiness.md` | 13 | `- Placeholder URL: `https://github.com/fontgarden/virtua-grotesk`` |
| stale placeholder guard | `documentation/public-upstream-readiness.md` | 61 | `\| `scripts/package_gf_dry_run.sh` \| 100 \| `stale_placeholder_upstream_url="https://github.com/fontgarden/virtua-grotesk"` \|` |
