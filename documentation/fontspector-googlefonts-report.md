...
<details><summary>[4] fonts/ttf/VirtuaGrotesk-SemiBold.ttf</summary>
<div>
...
|   Shaper didn't attach dotaccentcomb to Iogonek when shaping the text 'Į̇́'    |                              |
|   Shaper didn't attach acutecomb to dotaccentcomb when shaping the text 'Į̇́'  |                              |
|   Shaper didn't attach tildecomb to Iogonek when shaping the text 'Į̃'        |                              |
|   Shaper didn't attach dotaccentcomb to Iogonek when shaping the text 'Į̇̃'    |                              |
|   Shaper didn't attach tildecomb to dotaccentcomb when shaping the text 'Į̇̃'  |                              |
|   Shaper didn't attach tildecomb to J when shaping the text 'J̃'              |                              |
|   Shaper didn't attach dotaccentcomb to J when shaping the text 'J̇̃'          |                              |
|   Shaper didn't attach tildecomb to dotaccentcomb when shaping the text 'J̇̃'  |                              |
...
|   Shaper didn't attach acutecomb to edotaccent when shaping the text 'ė́'     |                              |
|   Shaper didn't attach tildecomb to edotaccent when shaping the text 'ė̃'     |                              |
|   Shaper didn't attach dotaccentcomb to dotlessi when shaping the text 'i̇́'   |                              |
|   Shaper didn't attach acutecomb to dotaccentcomb when shaping the text 'i̇́'  |                              |
|   Shaper didn't attach dotaccentcomb to dotlessi when shaping the text 'i̇̀'   |                              |
|   Shaper didn't attach gravecomb to dotaccentcomb when shaping the text 'i̇̀'  |                              |
|   Shaper didn't attach dotaccentcomb to dotlessi when shaping the text 'i̇̃'   |                              |
|   Shaper didn't attach tildecomb to dotaccentcomb when shaping the text 'i̇̃'  |                              |
|   Shaper didn't attach acutecomb to dotlessiogonek when shaping the text 'į́' |                              |
|   Shaper didn't attach acutecomb to dotlessiogonek when shaping the text 'į̇́' |                              |
|   Shaper didn't attach tildecomb to dotlessiogonek when shaping the text 'į̃' |                              |
|   Shaper didn't attach tildecomb to dotlessiogonek when shaping the text 'į̇̃' |                              |
|   Shaper didn't attach tildecomb to dotlessj when shaping the text 'j̃'       |                              |
|   Shaper didn't attach dotaccentcomb to dotlessj when shaping the text 'j̇̃'   |                              |
|   Shaper didn't attach tildecomb to dotaccentcomb when shaping the text 'j̇̃'  |                              |
|   Shaper didn't attach tildecomb to l when shaping the text 'l̃'              |                              |
|   Shaper didn't attach tildecomb to m when shaping the text 'm̃'              |                              |
|   Shaper didn't attach tildecomb to r when shaping the text 'r̃'              |                              |
...
* - uni062C.fina: X=614.5,Y=1 (should be at baseline 0?)
* - uni062D.fina: X=614.5,Y=1 (should be at baseline 0?)
* - uni0635 (U+0635): X=221.5,Y=-2.5 (should be at baseline 0?)
* - uni0635.fina: X=216.5,Y=-2.5 (should be at baseline 0?)
* - uni0636 (U+0636): X=221.5,Y=-2.5 (should be at baseline 0?)
* - uni0636.fina: X=221.5,Y=-2.5 (should be at baseline 0?)
* - uni0636.medi: X=221.5,Y=-2.5 (should be at baseline 0?)
* - uni0639.fina: X=54,Y=-295.5 (should be at descender -296?)
* - uni063A.fina: X=54,Y=-295.5 (should be at descender -296?)
...
* uni066F (U+066F): from (565.0, 228.0) to (565.0, 224.0) is colinear with segment from (565.0, 224.0) to (565.0, 221.0)
* uni0642 (U+0642): from (565.0, 228.0) to (565.0, 224.0) is colinear with segment from (565.0, 224.0) to (565.0, 221.0) [code: found-colinear-vectors]
...
* uni062C.fina: Line(Line { p0: (620.0, 171.0), p1: (621.0, 25.0) }) (angle: -89.61 degrees, expected: -90.00 degrees)
* uni062D.fina: Line(Line { p0: (620.0, 171.0), p1: (621.0, 25.0) }) (angle: -89.61 degrees, expected: -90.00 degrees) [code: found-semi-vertical]
...
<details><summary>[2] fonts/ttf/VirtuaGrotesk-Regular.ttf</summary>
<div>
...
* - uni0633.medi: X=177.5,Y=1 (should be at baseline 0?)
* - uni066F.fina: X=502,Y=2 (should be at baseline 0?)
* - uni066F.fina: X=450,Y=2 (should be at baseline 0?)
* - uni0642.fina: X=502,Y=2 (should be at baseline 0?)
* - uni0642.fina: X=450,Y=2 (should be at baseline 0?)
* - uni0647 (U+0647): X=276,Y=2 (should be at baseline 0?)
* - uni0647 (U+0647): X=318,Y=2 (should be at baseline 0?)
* - uni0629 (U+0629): X=276,Y=2 (should be at baseline 0?)
* - uni0629 (U+0629): X=318,Y=2 (should be at baseline 0?)
...
<details><summary>[3] fonts/ttf/VirtuaGrotesk-Bold.ttf</summary>
<div>
...
| Auxiliary orthography codepoints:                                            | * ro_Latn (Romanian)         |
|   The following auxiliary characters are missing from the font: Ţ            |                              |
|   The following auxiliary characters are missing from the font: ţ            |                              | [code: warning-language-shaping]
...
* - uni066E.fina: X=610.5,Y=-2.5 (should be at baseline 0?)
* - uni0628.fina: X=610.5,Y=-2.5 (should be at baseline 0?)
* - uni062A.fina: X=610.5,Y=-2.5 (should be at baseline 0?)
* - uni062B.fina: X=610.5,Y=-2.5 (should be at baseline 0?)
* - uni062C.fina: X=613.5,Y=-2.5 (should be at baseline 0?)
* - uni062D.fina: X=613.5,Y=-2.5 (should be at baseline 0?)
* - uni062D.medi: X=613.5,Y=-2.5 (should be at baseline 0?)
* - uni0633.medi: X=612.5,Y=-2.5 (should be at baseline 0?)
* - uni0633.medi: X=241,Y=1.5 (should be at baseline 0?)
...
* uni066F (U+066F): from (572.0, 222.0) to (572.0, 221.0) is colinear with segment from (572.0, 221.0) to (572.0, 218.0)
* uni0642 (U+0642): from (572.0, 222.0) to (572.0, 221.0) is colinear with segment from (572.0, 221.0) to (572.0, 218.0)
* uni06440627: from (354.0, 564.0) to (354.0, 566.0) is colinear with segment from (354.0, 566.0) to (354.0, 806.0) [code: found-colinear-vectors]
...
- 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1081, but got 1024 instead. [code: ascent]




- 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 398, but got 296 instead. [code: descent]
...
* U+0307 COMBINING DOT ABOVE: try adding one of: todhri, hebrew, malayalam, syriac, canadian-aboriginal, math, old-permic, coptic, tai-le, tifinagh, duployan
...
- 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 1094, but got 1024 instead. [code: ascent]




- 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 438, but got 296 instead. [code: descent]
...
<details><summary>[4] fonts/variable/VirtuaGrotesk[wght].ttf</summary>
<div>
...
* uni062C.fina (unencoded): found 4, expected one of: [2, 3]
* uni062D.fina (unencoded): found 3, expected one of: [1, 2]
* uni0635.init (unencoded): found 1, expected one of: [2]
* uni0636.init (unencoded): found 2, expected one of: [3, 5] [code: contour-count]
...
* - uni0633.medi: X=177.5,Y=1 (should be at baseline 0?)
* - uni0637.fina: X=540.5,Y=2.5 (should be at baseline 0?)
* - uni0637.medi: X=540,Y=2.5 (should be at baseline 0?)
* - uni066F.fina: X=502,Y=2 (should be at baseline 0?)
* - uni066F.fina: X=450,Y=2 (should be at baseline 0?)
* - uni0642.fina: X=502,Y=2 (should be at baseline 0?)
* - uni0642.fina: X=450,Y=2 (should be at baseline 0?)
* - uni0645.init: X=457,Y=1.5 (should be at baseline 0?)
* - uni0647 (U+0647): X=276,Y=2 (should be at baseline 0?)
... and 19 others [code: found-misalignments]
...
* uni0668 (U+0668) has a counter-clockwise outer contour
* eightFarsiar (U+06F8) has a counter-clockwise outer contour [code: ccw-outer-contour]
...
<details><summary>[2] fonts/ttf/VirtuaGrotesk-Medium.ttf</summary>
<div>
...
* - uni0633.medi: X=171.5,Y=-1.5 (should be at baseline 0?)
* - uni0635 (U+0635): X=423,Y=-2 (should be at baseline 0?)
* - uni0635.fina: X=412,Y=-2 (should be at baseline 0?)
* - uni0636 (U+0636): X=423,Y=-2 (should be at baseline 0?)
* - uni0636.fina: X=423,Y=-2 (should be at baseline 0?)
* - uni0636.medi: X=423,Y=-2 (should be at baseline 0?)
* - uni0637.medi: X=-11.5,Y=2.5 (should be at baseline 0?)
* - uni0637.init: X=-13,Y=2.5 (should be at baseline 0?)
* - uni0638.init: X=-13,Y=2.5 (should be at baseline 0?)
... and 19 others [code: found-misalignments]
