...
| `documentation/submission-handoff-readiness.md` | yes |
...
| `documentation/arabic-mark-readiness.md` | yes |
| `documentation/arabic-shaping-smoke-test.md` | yes |
...
- Path: `documentation/gftools-qa/Proof`
- Exists: yes
- HTML files: 16
...
- Review `documentation/package-dry-run-readiness.md` before running `GFT_PACKAGER_SOURCE_MODE=latest-release make package-dry-run`.
