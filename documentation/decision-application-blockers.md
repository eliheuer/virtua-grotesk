...
| Kerning | open | does not block | does not block directly | blocks until completed or deferred | 4 kerning warnings | UFO kerning/groups/features; build path if needed; warning triage |
