...
- Handoff file: `documentation/google-fonts-submission-handoff.md`
...
- Handoff mentions tracked package input count: yes
- Handoff mentions untracked package input count: yes
...
| --- | --- |
| `documentation/google-fonts-decisions.md` | yes |
| `documentation/decision-readiness.md` | yes |
| `documentation/google-fonts-add-font-template-audit.md` | yes |
| `documentation/google-fonts-add-font-issue-draft.md` | yes |
| `documentation/fontspector-googlefonts-report.md` | yes |
| `documentation/arabic-review-packet.md` | yes |
| `documentation/missing-gf-arabic-core.md` | yes |
| `documentation/missing-gf-latin-core.md` | yes |
| `documentation/release-source-readiness.md` | yes |
| `documentation/release-archive-manifest.md` | yes |
| `documentation/github-release-draft.md` | yes |
| `documentation/github-release-notes.md` | yes |
| `documentation/upstream-structure-readiness.md` | yes |
| `documentation/google-fonts-package-checklist.md` | yes |
| `documentation/package-source-files-audit.md` | yes |
| `documentation/package-dry-run-readiness.md` | yes |
| `documentation/google-fonts-metadata-review.md` | yes |
| `documentation/downstream-metadata-readiness.md` | yes |
| `documentation/downstream-metadata-diff.md` | yes |
| `documentation/downstream-pr-readiness.md` | yes |
| `documentation/google-fonts-language-metadata.md` | yes |
| `documentation/google-fonts-downstream-package-preview.md` | yes |
| `documentation/article-readiness.md` | yes |
| `documentation/authorship-disclosure-readiness.md` | yes |
| `documentation/pr-identity-readiness.md` | yes |
| `documentation/designer-profile-readiness.md` | yes |
| `documentation/designer-profile-package-draft.md` | yes |
| `documentation/drawbot-runtime-readiness.md` | yes |
| `documentation/local-workflow-readiness.md` | yes |
| `documentation/recent-google-fonts-packages.md` | yes |
| `documentation/vendor-id-readiness.md` | yes |
| `documentation/kerning-readiness.md` | yes |
| `documentation/kerning-proof-review.md` | yes |
| `documentation/avar-readiness.md` | yes |
| `documentation/pua-scope.md` | yes |
| `documentation/glyph-reachability.md` | yes |
| `documentation/numeric-feature-readiness.md` | yes |
| `documentation/fontspector-warnings.md` | yes |
| `documentation/final-submission-blockers.md` | yes |
| `documentation/next-actions.md` | yes |
