...
- Google Fonts QA proof files: 16 / 16 present in `documentation/gftools-qa/Proof`.
- Contour-count cleanup: 0 current review items; keep
  `documentation/contour-cleanup-decision-log.md` as evidence, but do not
...
Start with `documentation/arabic-manual-review-dashboard.html` for a compact
...
`documentation/arabic-print-proof.pdf`. The PDF uses the same local
...
and Bold. Use `documentation/arabic-print-proof-index.md` as the page map when
...
Use `documentation/arabic-manual-review-batches.md` for the shortest active
...
`documentation/arabic-next-review-batch.html` as the focused working page for
the next unresolved batch and `documentation/arabic-manual-review-dashboard.html`
...
`documentation/contour-cleanup-decision-log.md`, and
`documentation/fontspector-contour-count.md` should stay synchronized after
...
For each row in `documentation/arabic-visual-review-log.md`, record one of:
