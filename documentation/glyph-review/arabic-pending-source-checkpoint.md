...
| `mark-base+damma` | 4 |
| `mark-base+kasra` | 4 |
| `mark-shadda+sukun` | 10 |
| `mark-tanween` | 8 |
| `mark-hamza-above-below` | 6 |
| `mark-dotted-circle` | 14 |
| `class-mark-combinations` | 28 |
| `class-dot-stack-helpers` | 26 |
| `proof-regular-text` | 0 |
| `proof-regular-proofer` | 0 |
| `proof-regular-waterfall` | 0 |
| `proof-medium-text` | 0 |
| `proof-medium-proofer` | 0 |
| `proof-medium-waterfall` | 0 |
| `proof-semibold-text` | 0 |
| `proof-semibold-proofer` | 0 |
| `proof-semibold-waterfall` | 0 |
| `proof-bold-text` | 0 |
| `proof-bold-proofer` | 0 |
| `proof-bold-waterfall` | 0 |
| `smoke-salaam` | 0 |
| `smoke-arabic` | 0 |
| `smoke-bismillah` | 0 |
| `smoke-lam-alef` | 0 |
| `class-arabic-farsi-numerals` | 40 |
| `class-arabic-punctuation` | 32 |
...
| `arabicSignSanah` | `class-arabic-punctuation` | width 0; unicode 0601; contours 1; components 0; points 6; bbox `-156,544,156,656` | width 0; unicode 0601; contours 1; components 0; points 6; bbox `-156,544,156,656` | yes | - |
| `asterisk-ar` | `class-arabic-punctuation` | width 600; unicode 066D; contours 4; components 0; points 16; bbox `124,220,476,584` | width 600; unicode 066D; contours 4; components 0; points 16; bbox `124,220,476,584` | yes | - |
| `beh-ar` | `mark-base+fatha`, `mark-base+damma`, `mark-base+kasra`, `mark-shadda+sukun`, `mark-tanween`, `mark-hamza-above-below`, `class-mark-combinations` | width 600; unicode 0628; contours 0; components 2; points 0; bbox `none` | width 600; unicode 0628; contours 0; components 2; points 0; bbox `none` | yes | `behDotless-ar`<br>`dotbelow-ar` |
| `comma-ar` | `class-arabic-punctuation` | width 280; unicode 060C; contours 1; components 0; points 4; bbox `76,-56,188,132` | width 280; unicode 060C; contours 1; components 0; points 4; bbox `76,-56,188,132` | yes | - |
| `damma-ar` | `mark-base+damma`, `mark-dotted-circle`, `class-mark-combinations` | width 0; unicode 064F; contours 1; components 0; points 9; bbox `-72,0,44,148` | width 0; unicode 064F; contours 1; components 0; points 9; bbox `-72,0,44,148` | yes | - |
| `dammatan-ar` | `mark-tanween`, `mark-dotted-circle`, `class-mark-combinations` | width 0; unicode 064C; contours 2; components 0; points 18; bbox `-96,0,104,116` | width 0; unicode 064C; contours 2; components 0; points 18; bbox `-96,0,104,116` | yes | - |
| `dateSeparator-ar` | `class-arabic-punctuation` | width 300; unicode 060D; contours 1; components 0; points 4; bbox `112,156,220,584` | width 300; unicode 060D; contours 1; components 0; points 4; bbox `112,156,220,584` | yes | - |
...
| `parenright-ar` | `class-arabic-punctuation` | width 600; unicode FD3F; contours 1; components 0; points 10; bbox `60,-96,280,800` | width 600; unicode FD3F; contours 1; components 0; points 10; bbox `60,-96,280,800` | yes | - |
| `perMille-ar` | `class-arabic-punctuation` | width 600; unicode 0609; contours 4; components 0; points 16; bbox `116,160,526,584` | width 600; unicode 0609; contours 4; components 0; points 16; bbox `116,160,534,584` | yes | - |
| `percent-ar` | `class-arabic-punctuation` | width 600; unicode 066A; contours 3; components 0; points 12; bbox `116,160,520,584` | width 600; unicode 066A; contours 3; components 0; points 12; bbox `116,160,520,584` | yes | - |
| `question-ar` | `class-arabic-punctuation` | width 480; unicode 061F; contours 2; components 0; points 18; bbox `132,64,396,552` | width 480; unicode 061F; contours 2; components 0; points 18; bbox `132,58,396,552` | yes | - |
| `seen-ar` | `proof-regular-glyphs`, `proof-medium-glyphs`, `proof-semibold-glyphs`, `proof-bold-glyphs`, `class-letter-structures` | width 864; unicode 0633; contours 1; components 0; points 61; bbox `-368,-296,768,432` | width 864; unicode 0633; contours 1; components 0; points 61; bbox `-368,-296,768,432` | yes | - |
| `seenSixdots-ar` | `class-dot-stack-helpers` | width 864; unicode 069C; contours 7; components 0; points 43; bbox `72,-176,776,692` | width 864; unicode 069C; contours 7; components 0; points 43; bbox `72,-192,776,708` | yes | - |
| `seenSixdots-ar.fina` | `class-dot-stack-helpers` | width 864; unicode -; contours 10; components 0; points 43; bbox `72,-176,776,692` | width 864; unicode -; contours 10; components 0; points 43; bbox `72,-184,776,700` | yes | - |
| `seenSixdots-ar.init` | `class-dot-stack-helpers` | width 600; unicode -; contours 10; components 0; points 40; bbox `-24,-176,624,692` | width 600; unicode -; contours 10; components 0; points 40; bbox `-24,-184,624,700` | yes | - |
| `seenSixdots-ar.medi` | `class-dot-stack-helpers` | width 600; unicode -; contours 10; components 0; points 40; bbox `-24,-176,624,692` | width 600; unicode -; contours 10; components 0; points 40; bbox `-24,-184,624,700` | yes | - |
...
| `six-ar` | `class-arabic-farsi-numerals` | width 600; unicode 0666; contours 1; components 0; points 7; bbox `148,176,508,584` | width 600; unicode 0666; contours 1; components 0; points 7; bbox `148,176,508,584` | yes | - |
| `sixFarsi-ar` | `class-arabic-farsi-numerals` | width 600; unicode 06F6; contours 2; components 0; points 10; bbox `152,232,520,584` | width 600; unicode 06F6; contours 2; components 0; points 10; bbox `152,232,520,584` | yes | - |
| `smallHighThreeDots-ar` | `class-dot-stack-helpers` | width 0; unicode 06DB; contours 3; components 0; points 12; bbox `-76,620,76,724` | width 0; unicode 06DB; contours 3; components 0; points 12; bbox `-82,614,82,730` | yes | - |
...
| `threedotsupbelow-ar` | `class-dot-stack-helpers` | width 600; unicode -; contours 3; components 0; points 12; bbox `222,-106,378,10` | width 600; unicode -; contours 3; components 0; points 12; bbox `216,-112,384,16` | yes | - |
| `two-ar` | `class-arabic-farsi-numerals` | width 600; unicode 0662; contours 1; components 0; points 16; bbox `112,176,480,584` | width 600; unicode 0662; contours 1; components 0; points 16; bbox `112,176,480,584` | yes | - |
| `twoFarsi-ar` | `class-arabic-farsi-numerals` | width 600; unicode 06F2; contours 1; components 0; points 16; bbox `100,232,500,584` | width 600; unicode 06F2; contours 1; components 0; points 16; bbox `100,232,500,584` | yes | - |
| `twodotshorizontalbelow-ar` | `class-dot-stack-helpers` | width 600; unicode -; contours 2; components 0; points 8; bbox `230,-106,370,-62` | width 600; unicode -; contours 2; components 0; points 8; bbox `224,-112,376,-56` | yes | - |
| `twodotsverticalabove-ar` | `class-dot-stack-helpers` | width 600; unicode -; contours 2; components 0; points 8; bbox `278,590,322,714` | width 600; unicode -; contours 2; components 0; points 8; bbox `272,584,328,720` | yes | - |
| `twodotsverticalbelow-ar` | `class-dot-stack-helpers` | width 600; unicode -; contours 2; components 0; points 8; bbox `278,-106,322,18` | width 600; unicode -; contours 2; components 0; points 8; bbox `272,-112,328,24` | yes | - |
| `waw-ar` | `proof-regular-glyphs`, `proof-medium-glyphs`, `proof-semibold-glyphs`, `proof-bold-glyphs`, `class-letter-structures` | width 570; unicode 0648; contours 2; components 0; points 44; bbox `-128,-256,538,408` | width 570; unicode 0648; contours 2; components 0; points 44; bbox `-128,-256,538,408` | yes | - |
| `zero-ar` | `class-arabic-farsi-numerals` | width 600; unicode 0660; contours 1; components 0; points 4; bbox `272,356,328,412` | width 600; unicode 0660; contours 1; components 0; points 4; bbox `262,346,338,422` | yes | - |
| `zeroFarsi-ar` | `class-arabic-farsi-numerals` | width 600; unicode 06F0; contours 2; components 0; points 18; bbox `120,264,480,520` | width 600; unicode 06F0; contours 2; components 0; points 18; bbox `120,264,480,520` | yes | - |
