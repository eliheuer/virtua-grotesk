...
fn main() {
    ...
    let furn = 22.0;
    ctx.font("Geist Mono").font_size(furn).fill(t.furniture);
    ...
    r.render_to_png(&ctx, "documentation/specimen-portrait.png").expect("render");
}
