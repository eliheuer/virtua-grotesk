...
| Public upstream URL | `documentation/google-fonts-submission-handoff.md` | `documentation/google-fonts-submission-handoff.md` | 1 / 1 |
| Public upstream URL | `documentation/google-fonts-metadata-review.md` | `documentation/google-fonts-metadata-review.md` | 1 / 1 |
...
| Packager source strategy | `documentation/google-fonts-package-checklist.md` | `documentation/google-fonts-package-checklist.md` | 1 / 1 |
| Packager source strategy | `documentation/google-fonts-downstream-package-preview.md` | `documentation/google-fonts-downstream-package-preview.md` | 1 / 1 |
| Packager source strategy | `documentation/package-source-files-audit.md` | `documentation/package-source-files-audit.md` | 1 / 1 |
| Author/contact lines | `AUTHORS.txt` | `AUTHORS.txt` | 1 / 1 |
| Author/contact lines | `CONTRIBUTORS.txt` | `CONTRIBUTORS.txt` | 1 / 1 |
| Author/contact lines | `documentation/google-fonts-metadata-review.md` | `documentation/google-fonts-metadata-review.md` | 1 / 1 |
| Family name, namecheck, trademarks, and CLA | `documentation/google-fonts-submission-handoff.md` | `documentation/google-fonts-submission-handoff.md` | 1 / 1 |
| Family name, namecheck, trademarks, and CLA | `documentation/google-fonts-package-checklist.md` | `documentation/google-fonts-package-checklist.md` | 1 / 1 |
...
| Copyright authorship and AI disclosure | `documentation/google-fonts-submission-handoff.md` | `documentation/google-fonts-submission-handoff.md` | 1 / 1 |
...
| Custom sample text | `documentation/google-fonts-metadata-review.md` | `documentation/google-fonts-metadata-review.md` | 1 / 1 |
| Custom sample text | `documentation/google-fonts-package-checklist.md` | `documentation/google-fonts-package-checklist.md` | 1 / 1 |
| First-submission script scope | `documentation/google-fonts-submission-handoff.md` | `documentation/google-fonts-submission-handoff.md` | 1 / 1 |
| First-submission script scope | `documentation/google-fonts-metadata-review.md` | `documentation/google-fonts-metadata-review.md` | 1 / 1 |
| First-submission script scope | `documentation/missing-gf-arabic-core.md` | `documentation/missing-gf-arabic-core.md` | 1 / 1 |
| First-submission script scope | `documentation/fontspector-warnings.md` | `documentation/fontspector-warnings.md` | 1 / 1 |
| First-submission script scope | source glyphset, features, and proofs | n/a | n/a |
| Private-use icon block | source glyphset | n/a | n/a |
| Private-use icon block | `documentation/google-fonts-submission-handoff.md` | `documentation/google-fonts-submission-handoff.md` | 1 / 1 |
| Private-use icon block | `documentation/google-fonts-metadata-review.md` | `documentation/google-fonts-metadata-review.md` | 1 / 1 |
...
| Vendor ID | `documentation/fontspector-warnings.md` | `documentation/fontspector-warnings.md` | 1 / 1 |
...
| Version strategy | `documentation/google-fonts-metadata-review.md` | `documentation/google-fonts-metadata-review.md` | 1 / 1 |
| Version strategy | `documentation/google-fonts-release-checklist.md` | `documentation/google-fonts-release-checklist.md` | 1 / 1 |
| Version strategy | downstream `METADATA.pb` | n/a | n/a |
| Upstream release tag | `documentation/google-fonts-release-checklist.md` | `documentation/google-fonts-release-checklist.md` | 1 / 1 |
| Upstream release tag | `documentation/google-fonts-submission-handoff.md` | `documentation/google-fonts-submission-handoff.md` | 1 / 1 |
| Upstream release tag | downstream Google Fonts issue/PR text | n/a | n/a |
| Article or legacy description | `documentation/ARTICLE.en_us.html` | `documentation/ARTICLE.en_us.html` | 1 / 1 |
| Article or legacy description | `documentation/google-fonts-package-checklist.md` | `documentation/google-fonts-package-checklist.md` | 1 / 1 |
...
| Project template automation | `documentation/google-fonts-template-and-pr-audit.md` | `documentation/google-fonts-template-and-pr-audit.md` | 1 / 1 |
| Project template automation | `documentation/google-fonts-release-checklist.md` | `documentation/google-fonts-release-checklist.md` | 1 / 1 |
...
| Add Font issue and handoff text | `make issue-draft` and `documentation/submission-handoff-readiness.md` | generated drafts | Keeps current template labels, issue text, Fontspector counts, Arabic scope, and report references synchronized after decisions are applied. |
...
| Decision-linked warnings | `documentation/fontspector-warnings.md` and `documentation/final-submission-blockers.md` | evidence only | Groups Vendor ID, kerning, avar, PUA/reachability, and subsetting warnings for maintainer acceptance or follow-up fixes. |
