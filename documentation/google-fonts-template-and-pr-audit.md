...
`documentation/recent-google-fonts-packages.md` reads the selected downstream
...
- generated local comparison in `documentation/recent-google-fonts-packages.md`
...
`documentation/google-fonts-decisions.md` and summarized in
...
checkout in `documentation/recent-google-fonts-packages.md`. Refresh that
...
Regenerate `documentation/recent-google-fonts-packages.md` after updating the
...
- The Article flow is the decided first-submission path. The guide says
  ...
  new-font PRs commonly do. Use `documentation/ARTICLE.en_us.html` as the
