...
| `make test` is ready for final Fontspector review | Fontspector FAIL results: 0; WARN results: 10; INFO results: 38; PASS results: 529; SKIP results: 302; contour decisions pending: 0 | `documentation/fontspector-googlefonts-report.md`; `documentation/contour-cleanup-decision-log.md` | proven |
