...
This report records Google Fonts-facing metadata from the active UFO sources. Use it with `documentation/generated-font-metadata.md` to confirm that source metadata and built binary metadata stay aligned.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| `sources/VirtuaGrotesk-Regular.ufo` | 1024 | 832 | -256 | 576 | 768 | 1024/-296/0 | 1024/296 | 1024/-296/0 |
| `sources/VirtuaGrotesk-Bold.ufo` | 1024 | 832 | -256 | 576 | 768 | 1024/-296/0 | 1024/296 | 1024/-296/0 |
