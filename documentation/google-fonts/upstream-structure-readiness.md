...
- documentation/assets/image-license.txt present: yes
...
- Article draft present: no
- Description draft present: no
- Image provenance present: no
- README specimen image present: no
