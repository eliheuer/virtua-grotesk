...
Track those decisions in `documentation/google-fonts-decisions.md`.
Regenerate `documentation/google-fonts-add-font-template-audit.md` from the
local `google/fonts` fork before opening the issue, then update this handoff if
the template changed.
Use `documentation/google-fonts-add-font-issue-draft.md` as the canonical
...
- Current Arabic target: `GF_Arabic_Core`; see
  `documentation/arabic-review-packet.md` and
...
- Current Article draft: `documentation/ARTICLE.en_us.html`
...
- Review `documentation/arabic-shaping-smoke-test.md` after each drawing/build pass.
- Review `documentation/arabic-mark-readiness.md` after each Arabic mark pass.
- Review `documentation/arabic-review-packet.md` as the consolidated Arabic
...
- Decide whether PUA/private icons are in scope for the first submission, then
  regenerate `documentation/pua-scope.md`.
...
- Vendor ID is decided as `FTGD` for Font Garden and is applied in sources and
  generated fonts; keep reviewing `documentation/vendor-id-readiness.md` after
...
- Author/contact display, copyright-authorship statement, AI-use disclosure,
  ...
  with `documentation/authorship-disclosure-readiness.md`,
  `documentation/family-name-readiness.md`, and
...
- Keep the decided Article flow in the downstream package and recheck
  `documentation/ARTICLE.en_us.html` with `documentation/article-readiness.md`
  after final source or URL changes.

**Image:**

Use `documentation/readme-specimen.png` unless a better final specimen image is
...
`documentation/google-fonts-downstream-package-preview.md`, rejects pending
...
See `documentation/google-fonts-package-checklist.md` for the final upstream
and downstream review checklist. Use
`documentation/downstream-pr-readiness.md` to check the issue-first rule,
...
`documentation/decision-readiness.md` to confirm open maintainer decisions
...
`documentation/upstream-structure-readiness.md` to confirm the repo still
matches the preferred Google Fonts upstream shape before packaging. Use
`documentation/google-fonts-metadata-review.md` when reviewing generated
`METADATA.pb`. Use `documentation/google-fonts-template-and-pr-audit.md` and
`documentation/recent-google-fonts-packages.md` to compare the final package
...
`documentation/google-fonts-language-metadata.md` to confirm the Arabic
language/subset metadata evidence before reviewing the final `METADATA.pb`. Use
`documentation/google-fonts-downstream-package-preview.md` as the expected
downstream file-layout and `METADATA.pb` shape during local package review.
Use `documentation/downstream-metadata-readiness.md` to check the generated
metadata preview fields, including the source block, subsets, and SemiBold
style spelling. Use `documentation/downstream-metadata-diff.md` to compare the
...
Use `documentation/package-source-files-audit.md` to confirm the `source.files`
...
`documentation/package-dry-run-readiness.md` to review the current
source-mode blockers, including tracked/untracked package inputs, before
running Packager.
Use `documentation/authorship-disclosure-readiness.md` to keep the Add Font
authorship and AI-use disclosure wording explicit before checking the combined
template requirement. Use `documentation/pr-identity-readiness.md` to confirm
git identity, GitHub API credentials, and CLA status before packaging or
opening a downstream PR. Use `documentation/designer-profile-readiness.md` and
`documentation/designer-profile-package-draft.md` to confirm the designer
...
strings. Use
`documentation/drawbot-runtime-readiness.md` and
`documentation/local-workflow-readiness.md` to confirm final proofs use the
local `eliheuer/drawbot-skia` fork and that the local handoff commands are
runnable.
Use `documentation/missing-gf-latin-core.md` and
`documentation/missing-gf-arabic-core.md` to keep the issue text aligned with
current glyphset coverage gaps. Use `documentation/arabic-review-packet.md` as
the compact Arabic scope and proofing packet before requesting Arabic/RTL
review labels.
Use `documentation/vendor-id-readiness.md`,
`documentation/kerning-readiness.md`,
`documentation/kerning-proof-review.md`, `documentation/avar-readiness.md`,
`documentation/pua-scope.md`, `documentation/glyph-reachability.md`,
`documentation/numeric-feature-readiness.md`, and
`documentation/fontspector-warnings.md` to review decision-linked warning
...
Use `documentation/release-source-readiness.md` to confirm the final public
source commit, tag, branch, selected source mode, and local `google/fonts` fork
state. Use `documentation/release-archive-manifest.md` to confirm the local
...
`documentation/github-release-draft.md` and
`documentation/github-release-notes.md` to review the exact release command,
tag, title, archive asset, and release notes before publishing the final
GitHub release. Use
`documentation/article-readiness.md` to confirm Article HTML, image,
and upstream-link readiness. Use `documentation/next-actions.md` as the
owner-grouped remaining-work queue. Use
`documentation/final-submission-blockers.md` as the final compact open-blocker
summary. Regenerate
`documentation/submission-handoff-readiness.md` before opening the Add Font
