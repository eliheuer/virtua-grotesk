...
| Current handoff gate | `make preflight` | Builds, regenerates the main proof PDF, the focused Arabic PDF proof, and reports, then allows only documented drawing/source blockers. | Before handing work back or before any packaging/release milestone. |
