...
- Preview file: `documentation/google-fonts-downstream-package-preview.md`
...
| `documentation/ARTICLE.en_us.html` | `article/ARTICLE.en_us.html` | yes | yes |
| `documentation/readme-specimen.png` | `article/readme-specimen.png` | yes | yes |
...
| --- | --- | --- | --- |
| `designer` | `Eli Heuer` | Matching designer profile or profile request | `documentation/google-fonts-downstream-package-preview.md`; designer catalog draft if needed |
