...
`documentation/arabic-visual-review-log.md` remains the authority for
...
- `documentation/arabic-review-snapshots/mark-base+fatha.png`
- `documentation/arabic-review-snapshots/mark-base+damma.png`
- `documentation/arabic-review-snapshots/mark-base+kasra.png`
- `documentation/arabic-review-snapshots/mark-shadda+sukun.png`
- `documentation/arabic-review-snapshots/mark-tanween.png`
- `documentation/arabic-review-snapshots/mark-hamza-above-below.png`
- `documentation/arabic-review-snapshots/mark-dotted-circle.png`
- `documentation/arabic-review-snapshots/class-mark-combinations.png`
