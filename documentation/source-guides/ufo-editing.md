...
4. **Verify after edit** — suggest running `make reports-only` to refresh `documentation/source/master-compatibility.md`, or `make preflight` for a fresh build plus checks
